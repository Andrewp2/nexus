...
pub fn EndUserLicenseAgreement() -> impl IntoView {
    view! {
        ...
        <h2 class="">"$GAME Terms of Service"</h2>
        <h3>"General"</h3>
        <ul>
            <li>
            ...
            <li>
                "If there is anything you are wondering about in connection with the use of $GAME or with these Terms of Service, do not hesitate to contact me at andrew@ProjectGlint.com"
            </li>
        </ul>
